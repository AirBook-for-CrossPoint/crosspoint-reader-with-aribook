...
class ButtonNavigator final {
 ...
 public:
  ...
  [[nodiscard]] static int currentTouchListIndex(const Rect& rect, int itemCount, int selectedIndex, int rowHeight,
                                                 uint32_t maxAgeMs = 1000);
  [[nodiscard]] static int currentTouchHorizontalIndex(const Rect& rect, int itemCount, uint32_t maxAgeMs = 1000);
